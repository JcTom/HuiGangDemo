...
import com.suctan.huigangdemo.bean.address.JsonBean;
...
public class JsonDataActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void ShowPickerView() {// 弹出选择器
        OptionsPickerView pvOptipns = new OptionsPickerView(this){

        };
        pvOptipns.setPicker(options1Items,options2Items,options3Items,true);
        pvOptipns.setCyclic(false);
        pvOptipns.show();
    }
