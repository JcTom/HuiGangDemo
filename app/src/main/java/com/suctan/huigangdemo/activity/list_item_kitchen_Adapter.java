...
public class list_item_kitchen_Adapter extends Activity {
    private ListView lv;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(getApplicationContext(),"你点击了第position行",Toast.LENGTH_SHORT).show();
             }
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.btn_add_today_food:
                    System.out.println("btn_add_today_food");
                    break;
                case R.id.btn_add_new_food:
                    System.out.println("btn_add_new_food");
                    break;
            }
        }
    };
