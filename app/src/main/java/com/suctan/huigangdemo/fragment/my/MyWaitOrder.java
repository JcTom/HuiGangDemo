...
public class MyWaitOrder extends MvpFragment<MyBuyOrderPresenter>implements MyBuyOrderView {

    //这个fragment对应这个，我卖出的中的两个选项栏中的已完成
    private InterFaceOrderState Listner;

    public static MyWaitOrder getFragmentInstant() {
        MyWaitOrder waitReceiveFrag = new MyWaitOrder();
